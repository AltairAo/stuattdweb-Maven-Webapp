...
public class SysUserController extends StuattdBaseController<SysUser> implements Constant {
	...
	public void logout(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		response.sendRedirect("/stuattd/login.jsp");
	}
	...
	public void getSysUser(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<SysUser> stuattdList = sysUserService.getSysUserList(queryResult.getResultList());
		ListView<SysUser> stuattdListView = new ListView<SysUser>();
