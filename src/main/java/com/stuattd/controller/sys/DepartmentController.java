...
public class DepartmentController extends StuattdBaseController<Department> {
	...
	public void getSysUser(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ListView<Department> stuattdListView = new ListView<Department>();
		stuattdListView.setData(queryResult.getResultList());
