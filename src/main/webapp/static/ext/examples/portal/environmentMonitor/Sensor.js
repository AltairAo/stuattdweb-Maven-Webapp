 ...
 */
// 传感器位置标识
Ext.define('Stuattd.app.environmentMonitor.Sensor', {
	extend : 'Ext.panel.Panel',
	initComponent : function() {
		var me = this;
		Ext.apply(this, {
			layout : 'border',
			items : [ Ext.create('Stuattd.app.environmentMonitor.SensorLeaflet'), Ext.create('Stuattd.app.environmentMonitor.SensorGrid', {
...
// 传感器在Leaflet地图的位置标识
Ext.define('Stuattd.app.environmentMonitor.SensorLeaflet', {
	extend : 'Ext.panel.Panel',
	region : 'north',
	height : '50%',
	split : true,
...
Ext.define('Stuattd.app.environmentMonitor.SensorGrid', {
