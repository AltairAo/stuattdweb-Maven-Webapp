 ...
 */
// 权限管理
Ext.define('Stuattd.app.systemManage.AuthorizationManagement', {
	extend : 'Ext.panel.Panel',
	initComponent : function() {
		var me = this;
		Ext.apply(this, {
			layout : 'border',
			items : [ Ext.create('Stuattd.app.systemManage.AuthorizationManagement.SysUserGrid', {
				cButtons : me.cButtons,
				cName : me.cName
			}), Ext.create('Stuattd.app.systemManage.AuthorizationManagement.MenuTree') ]
		});
...
// 角色列表
Ext.define('Stuattd.app.systemManage.AuthorizationManagement.SysUserGrid', {
...
// 树形菜单
Ext.define('Stuattd.app.systemManage.AuthorizationManagement.MenuTree', {
