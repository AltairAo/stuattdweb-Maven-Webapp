...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${contextPath}/static/css/stuattd-style.css"  />
	    ...
	    <script type="text/javascript">
	        ...
	        Ext.Loader.setPath('Stuattd.app', '${contextPath}/static/ext/examples/portal');
	    </script>
